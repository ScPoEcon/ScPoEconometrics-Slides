...
.right[<span style="font-style:italic; font-size: 18px">Haavelmo (1944). The Probability Apporach to Econometrics.</span>]
</blockquote>
...
.pull-right[
In practice:
![Learning R](chapter1_files/figure-html/learning_path.png)
]
...
<img src="chapter1_files/figure-html/gator_error.jpg" alt="Gator collaboration" width="900" style="display: block; margin-left: auto; margin-right: auto"/>
...
&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; [Book](https://scpoecon.github.io/ScPoEconometrics/) &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; | &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; [Slides](https://github.com/ScPoEcon/ScPoEconometrics-Slides) &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; | &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;  [Interactive R Apps](https://github.com/ScPoEcon/ScPoApps) &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
-- | -- | --
...
You can message me through **Slack** (no emails! ***EVER***) if you have any question

I will only be checking my PMs between 12h and 14h
]

.pull-right[
***Class conduct and expectations***

*Late work:* 3 points deducted for every late day.

*Cheating:* We will have a chat about it and you will get a 0. Just don't cheat, it's honestly not worth it.
]
...
> ***Pay attention to your mental health in the same way you would for your physical health!***

--

Seeking help is a sign perceptive self-awareness, not weakness
...
To combat everyone's social isolation (mine included!), I propose we meet weekly on [gather.town](https://gather.town/) every Friday at 17h `r emo::ji("hugs")`
