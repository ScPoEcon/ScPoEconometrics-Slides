...
3. There will be _no_ final exam `r emo::ji("sweat_smile")`.
...
.center[![Santé publique France](chapter_intro_files/figure-html/sante_publique_france.png)]
...
* Most of the time you will be cleaning data
...
#   path = "chapter_intro_files/figure-html",
#   width = 9,
#   height = 4,
#   units = "in",
#   res = 150,
...
# Vectors => Comment: if you think this lecture up until now lasts more than 2 hours, I would be in favor of moving the rest of this lecture to Lecture 2/3.
...
* Import gun_murders.csv<sup>1</sup> in a new object `murders`. This file contains data on gun murders by US state in 2010. (Hint: objects are created using `=`)
