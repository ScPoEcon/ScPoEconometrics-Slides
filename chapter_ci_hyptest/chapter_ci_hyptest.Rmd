...
author: "Florian Oswald, Gustave Kenedi, Pierre Villedieu and Mylène Feuillade"
...
1\. From your ***computer*** `r emo::ji("backhand_index_pointing_right")` connect to [***www.wooclap.com/SCPOSAMP***](https://app.wooclap.com/SCPOSAMP)
...
knitr::include_graphics("chapter_ci_hyptest_files/figure-html/qr_code_quiz.png")
```
