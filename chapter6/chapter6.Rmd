...
df %>% 
  ggplot(aes(x = prop_green)) +
    geom_histogram(binwidth = 0.05, boundary = 0.425, color = "white", fill = "darkgreen") +
  scale_x_continuous(breaks = round(seq(0.3, 0.7, by = 0.1),1)) +
  labs(
...
df %>% 
  ggplot(aes(x = prop_green)) +
    geom_histogram(binwidth = 0.05, boundary = 0.525, color = "white", fill = "darkgreen") +
    scale_x_continuous(breaks = round(seq(0.3, 0.7, by = 0.1),1)) +
    labs(
