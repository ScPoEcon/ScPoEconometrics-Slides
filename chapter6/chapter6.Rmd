...
* We made sure to selecte them at **random**.

* Here is what we found.

Color | Count | Proportion
:------:|:------:|:--------:
Red   |  14        |  `r round(14/20,2)`
Green   |  5     |   `r round(5/20,2)`
White   |  1    |     `r round(1/20,2)`
...
:------:|:------:|:--------:
1 | 14 | `r round(14/20,2)`
2 | 14 | `r round(14/20,2)`
3 | 10 | `r round(10/20,2)`
4 | 10 | `r round(10/20,2)`
5 | 6 | `r round(6/20,2)`
6 | 10 | `r round(10/20,2)`
7 | 8 | `r round(8/20,2)`
8 | 9 | `r round(9/20,2)`
9 | 11 | `r round(11/20,2)`
]
...
12 | 9 | `r round(9/20,2)`
13 | 9 | `r round(9/20,2)`
14 | 14 | `r round(14/20,2)`
15 | 11 | `r round(11/20,2)`
16 | 10 | `r round(10/20,2)`
17 | 7 | `r round(7/20,2)`
18 | 13 | `r round(13/20,2)`
]
...
```{r, echo=FALSE, eval = TRUE, fig.height=8}
# p_vline <- ggplot(dft) +
#   geom_vline(xintercept = 352/(352+211+150), size = 1, colour = "black") +
#   geom_point(aes(x, y), shape = 21, colour = "black", fill = "darkgreen", size = 13, stroke = 1) +
#   labs(
#     x = "Proportion of green fusilli",
#     y = "Frequency"
...
#   transition_manual(.frame)
# p_vline
# anim_save(filename = "img/photos/hist_building_vline.gif", animation = p_vline)

knitr::include_graphics("../img/photos/hist_building_vline.gif")
```
]
