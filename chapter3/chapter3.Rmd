...
Note that the units of $x$ will matter for the interpretation (and magnitude!) of $b_1$.
---
...
# Task 4: Standardized OLS (7 minutes)

1. Create 2 variables (`std_math` and `std_verb`) that contain the standardized average math and verbal scores. You can use the `scale()` function in a `mutate` command.
 
2. Create a new variable `std_score` that associates to each class size a unique score equal to the average of the standardized math and verbal scores.
