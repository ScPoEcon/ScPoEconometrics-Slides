...
* R basics : first steps with R studio, import data, data handling 
...
* Empirical examples
  ...
  - The relation between **class size** and **students performance**
  - A **log wage example **
...
Let's start with the relation with **student performance and class size**.

The dataset we gonna use consists of test scores in fifth grade classes at public elementary schools in Israel. These data were originally used in [Angrist and Lavy (1999)]((https://www.dropbox.com/s/le8c38jrzma656t/angrist-lavy.pdf?dl=0)
...
```{r, echo=FALSE}
grades = read.csv2("https://www.dropbox.com/s/wwp2cs9f0dubmhr/grade5.dta?dl=1")
```
