...
1. Create a new object `brexit_3` which only contains the columns `state` and `total`. (Recall that `c` creates vectors.)

1. Create a `total_percap` variable equal to the number of brexit per 10,000 inhabitants by running the following code.
    ```{r}
