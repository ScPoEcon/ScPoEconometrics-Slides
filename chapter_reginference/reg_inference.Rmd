...
* When this assumption is violated it means our estimate $b$ is a **biased** estimate of $\beta$
...
* For example, imagine you are interested in the effect of education on wage
  ...
  * Under the exogeneity assumption $\beta_1$ denotes the causal effect of education in the poppulation.
...
* *Interpratation*: Taking repeated sample from the population and compute $b_1$ each time, we would **systematically overestimate** the effect of education on wage.
