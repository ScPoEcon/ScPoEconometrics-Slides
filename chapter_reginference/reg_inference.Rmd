...
1. Generate the bootstrap distribution of $b_\textrm{small}$ based on 1,000 samples drawn from `star_df`.  
...
1. Plot this simulated sampling distribution and compute the mean and standard error of $b_\textrm{small}$.
...
--
  ...
  * The classical regression model applies to **correctly specified linear regressions**: your model needs to be linear in parameters, include all relevant variables, and your variables cannot be colinear.
