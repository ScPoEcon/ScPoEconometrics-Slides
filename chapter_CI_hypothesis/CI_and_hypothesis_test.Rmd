...
--
  ...
  1. Repeat step 1 to 2 39 times, i.e. until your new sample is of the same size as the original sample.
...
visualize(null_distribution, bins = 10, fill = "#d90502") + 
  ...
  xlim(-0.4, 0.4) +
  annotate("text", x = 0.292, y = 200, label = "observed test statistic") +
  theme_bw(base_size = 14)
```
