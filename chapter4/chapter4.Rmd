...
* Let's see if these new *tools* can help understanding the relationship between wages, education and gender. 
...
* But, what about the evolution of the gender gap when considering different levels of education?  
...
* We observe a gender gap for each education group

* It is not clear if/how it varies with education
...
* Regress the `log_wage` on `gender`, `education` and `gender*education`, save it as `reg2`.
