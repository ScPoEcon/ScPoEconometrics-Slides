...
* Imagine you are interested in assessing the __causal__ impact of alcohol consumption on mortality.
...
1. Create a `facet_grid` ggplot with death rates for all causes (`mva`), motor vehicle-related causes (`mva`) and alcohol-related causes (`alcohol`) as a function of age.  
