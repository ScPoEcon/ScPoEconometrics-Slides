...
* Writing in regression form, we have
  ...
  where $DEATHRATE_a$ is the death rate at age $a$, $D_a$ is the treatment dummy, and $a$ is age.
...
$$\underbrace{\lim_{c \to 21^+} \mathbb{E}[DEATHRATE_a^1|a = c]}_{\alpha + \delta} - \underbrace{\lim_{c \to 21^-} \mathbb{E}[DEATHRATE_a^0|a = c]}_{\alpha} = \delta$$
