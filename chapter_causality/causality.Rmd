...
- `r emo::ji("warning")` It does **NOT** mean that `X` is the only factor only that causes `Y`
...
- Based on [(Cochran 1968)](https://www.jstor.org/stable/2528036?origin=crossref&seq=11#metadata_info_tab_contents), we compare **death rates** in 3 countries : Canada, U.K. and U.S.. 
