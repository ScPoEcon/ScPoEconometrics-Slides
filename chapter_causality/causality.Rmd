...
5) Bonus :  Compute the value of the **selection bias** and the **heterogenous trt effect bias** and check that we have $$SDO = ATE + \textrm{selection bias} + \textrm{heter. trt. effect bias}$$ 
