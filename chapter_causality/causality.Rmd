...
star_long = read.csv(file = "https://www.dropbox.com/s/bf1fog8yasw3wjj/star_data.csv?dl=1")
```
...
Let's only focus on one treatment group: small classes.
...
1 | math | `r round(diff_table[3,3], 2)` | `r round(diff_table[3,4], 2)` | `r round(diff_table[3,4] - diff_table[3,3], 2)`
1 | read | `r round(diff_table[4,3], 2)` | `r round(diff_table[4,4], 2)` | `r round(diff_table[4,4] - diff_table[4,3], 2)`
2 | math | `r round(diff_table[5,3], 2)` | `r round(diff_table[5,4], 2)` | `r round(diff_table[5,4] - diff_table[5,3], 2)`
2 | read | `r round(diff_table[6,3], 2)` | `r round(diff_table[6,4], 2)` | `r round(diff_table[6,4] - diff_table[6,3], 2)`
3 | math | `r round(diff_table[7,3], 2)` | `r round(diff_table[7,4], 2)` | `r round(diff_table[7,4] - diff_table[7,3], 2)`
3 | read | `r round(diff_table[8,3], 2)` | `r round(diff_table[8,4], 2)` | `r round(diff_table[8,4] - diff_table[8,3], 2)`
